## NutriDiab: Sistema de experto basado en el conocimiento en nutrición para la ayuda en la toma de decisiones alimenticias en personas con Diabetes Tipo 2 y personas prediabéticas
